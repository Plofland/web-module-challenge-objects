...
console.log(createMenuItem("Black Bean Burger", 7, "dinner"));
console.log(createMenuItem("Curry", 6, "dinner"));
...
export const burger = {
  ...
  price: 18, 
  category: "Lunch", 
  discount: function(disStr){
    if (disStr === "teacher" || disStr === "student"){
...
// console.log(reviews[name.includes("Julius")].feedback);
...
reviews.push({name: "Peter", rating: 5, feedback: "This place is great!"});
console.log(reviews)
